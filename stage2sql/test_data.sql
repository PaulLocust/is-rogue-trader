...
-- 6. Upgrades
INSERT INTO upgrades (id, name, description, cost_wealth, cost_industry, cost_resources, suitable_types) VALUES
(1, 'Irrigation Systems', 'Increases food production', 5000, 2000, 1000, 'AGRI_WORLD'),
(2, 'Deep Mining Shafts', 'Increases resource extraction', 8000, 3000, 5000, 'MINING_WORLD'),
(3, 'Ark-Tech Factories', 'Increases industrial power', 15000, 10000, 3000, 'FORGE_WORLD'),
(4, 'Hive Architecture', 'Improves living conditions', 12000, 8000, 4000, 'HIVE_WORLD'),
(5, 'Shield Generators', 'Protection from harsh conditions', 7000, 4000, 6000, 'DEATH_WORLD');
...
-- 8. Пример проекта (совместимый)
INSERT INTO projects (planet_id, upgrade_id, status) VALUES
(1, 1, 'PLANNED'); -- AGRI_WORLD + Irrigation Systems = OK

-- 9. Пример данных в ассоциативной таблице (после завершения проекта)
-- Сначала завершим проект
UPDATE projects SET status = 'COMPLETED' WHERE planet_id = 1 AND upgrade_id = 1;

-- Проверим, что данные появились в ассоциативной таблице
SELECT 'Data in planet_upgrades table:' as message;
